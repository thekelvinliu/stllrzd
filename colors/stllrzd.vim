...
hi NonText ctermfg=239 ctermbg=234 guifg=#424c55 guibg=#1c1e29 guisp=NONE cterm=NONE gui=NONE
hi Whitespace ctermfg=239 ctermbg=234 guifg=#424c55 guibg=#1c1e29 guisp=NONE cterm=NONE gui=NONE
hi Comment ctermfg=247 ctermbg=NONE guifg=#989c94 guibg=NONE guisp=NONE cterm=NONE,italic gui=NONE,italic
hi CursorLineNr ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi LineNr ctermfg=239 ctermbg=NONE guifg=#424c55 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi VisualNOS ctermfg=247 ctermbg=234 guifg=#989c94 guibg=#1c1e29 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Cursor ctermfg=250 ctermbg=234 guifg=#bcc3b8 guibg=#1c1e29 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi IncSearch ctermfg=136 ctermbg=234 guifg=#b88f0a guibg=#1c1e29 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ColorColumn ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi CursorLine ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi DiffChange ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi Folded ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi MatchParen ctermfg=71 ctermbg=239 guifg=#60a265 guibg=#424c55 guisp=NONE cterm=NONE,underline gui=NONE,underline
hi Pmenu ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi QuickFixLine ctermfg=NONE ctermbg=239 guifg=NONE guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi StatusLineNC ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi StatusLineTermNC ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi TabLine ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE,bold gui=NONE,bold
hi WildMenu ctermfg=145 ctermbg=239 guifg=#bead9d guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi PmenuSbar ctermfg=233 ctermbg=233 guifg=#040f16 guibg=#040f16 guisp=NONE cterm=NONE gui=NONE
hi PmenuThumb ctermfg=145 ctermbg=145 guifg=#bead9d guibg=#bead9d guisp=NONE cterm=NONE gui=NONE
hi TabLineFill ctermfg=239 ctermbg=239 guifg=#424c55 guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=239 ctermbg=239 guifg=#424c55 guibg=#424c55 guisp=NONE cterm=NONE gui=NONE
hi VertSplit ctermfg=233 ctermbg=233 guifg=#040f16 guibg=#040f16 guisp=NONE cterm=NONE gui=NONE
...
hi Search ctermfg=136 ctermbg=250 guifg=#ab8509 guibg=#bcc3b8 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
